module.exports = {
  dev: {
    accepted:
      '{0} ليس قيمة مقبولة لـ{1}، يرجى إستخدام أحد الإجراءات التالية: {2}.',
    ...
    sameEdge:
      'لا يمكن لحواف الشكل أن تكون متصله بنفسها، سيتم إزالة هذه الحواف تلقائيًا {0}.',
    set: 'تم حفظ {0}.',
  ...
  error: {
    accepted:
      '{0} ليس {1} مقبول للشكل البياني {2}، رجاءً إستخدم أحد هذه الطرق: {3}.',
