  ...
  if (group === "edges" || vars.labels.value) {
    ...
    selection.each(function(d){
      ...
      if (!disabled && ((label && label.force) || background || !fill)) {
        ...
        if (share && d.d3po.share && share.w-vars.labels.padding*2 >= 10 && share.h-vars.labels.padding*2 >= 10 && vars.labels.valign.value != "middle") {
          ...
          share.text = d.d3po.share;
          share.parent = d;

          var text = group.selectAll("text#d3po_share_"+d.d3po.id)
          ...
          if (vars.draw.timing && vars.zoom.scale === 1) {
            ...
            text.enter().append("text")
              .attr("id","d3po_share_"+d.d3po.id)
              .attr("class","d3po_share")
              .attr("opacity",0)
              .call(style)
              .transition().duration(vars.draw.timing/2)
          ...
          group.selectAll("text.d3po_share")
            .call(remove);
        }
