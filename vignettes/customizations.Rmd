...
d3po(pokemon_custom, width = 800, height = 600) %>%
  ...
  po_labels(x = "Pokemon Type (uppercase)", y = "Weight (grams)") %>%
...
d3po(pokemon_custom, width = 800, height = 600) %>%
  ...
  po_labels(y = "Pokemon Type (uppercase)", x = "Weight (grams)") %>%
  po_title("Weight Distribution by Type")
```
...
d3po(dout, width = 800, height = 600) %>%
  ...
  po_labels(x = "Type", y = "Mean Weight") %>%
...
d3po(dout, width = 800, height = 600) %>%
  ...
  po_labels(x = "Mean Weight", y = "Type") %>%
...
d3po(dout, width = 800, height = 600) %>%
  ...
  po_labels(x = "Height (m)", y = "Weight (kg)") %>%
