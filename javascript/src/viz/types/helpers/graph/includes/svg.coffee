...
module.exports = (vars) ->
  ...
  for axis in ["x", "x2", "y", "y2"]
    ...
    axisGroup = plane.selectAll("g#d3po_graph_" + axis + "ticks")
      .data realData
  ...
  for axis in ["x", "x2", "y", "y2"]
    ...
    label = vars.group.selectAll("text#d3po_graph_"+axis+"label")
      .data labelData
  ...
  for axis in ["x", "y", "x2", "y2"]
    ...
    if vars[axis].value
      ...
      lines = lineGroup.selectAll "line.d3po_graph_"+axis+"line"
      ...
      linetexts = lineGroup.selectAll "text.d3po_graph_"+axis+"line_text"
      ...
      linetexts.enter().append "text"
        ...
        .attr "id", (d) ->
          ...
          id = id.replace("-", "neg")
          id = id.replace(".", "p")
          "d3po_graph_"+axis+"line_text_"+id
        .attr "opacity", 0
        .call lineFont, axis
      ...
      rectStyle = (rect) ->
        ...
        getText  = (d) ->
          ...
          id = id.replace("-", "neg")
          id = id.replace(".", "p")
          plane.select("text#d3po_graph_"+d.axis+"line_text_"+id).node().getBBox()
      ...
      lineRects = lineGroup.selectAll "rect.d3po_graph_"+axis+"line_rect"
        .data rectData, (d) -> d.position

      lineRects.enter().insert("rect", "text.d3po_graph_"+axis+"line_text")
