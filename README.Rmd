...
In the `shinydemo` directory (https://github.com/pachadotdev/d3po/tree/master/shinydemo) there is a fully worked example with Shiny for all the available visualization types in the package.
