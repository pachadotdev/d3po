...
radar = (vars) ->
  ...
  rings = vars.group.selectAll ".d3po_radar_rings"
    .data ringData, (d, i) -> i
  ...
  labelGroup = vars.group.selectAll "g.d3po_radar_label_group"
    .data [0]
  labelGroup.enter().append("g").attr "class", "d3po_radar_label_group"
    .attr "transform", "translate(" + vars.width.viz/2 + "," + vars.height.viz/2 + ")"
  labelGroup.transition().duration(vars.draw.timing)
    .attr "transform", "translate(" + vars.width.viz/2 + "," + vars.height.viz/2 + ")"


  text = labelGroup.selectAll ".d3po_radar_labels"
  ...
  grid = vars.group.selectAll ".d3po_radar_lines"
